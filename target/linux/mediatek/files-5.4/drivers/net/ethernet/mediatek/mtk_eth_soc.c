                           ...
                           u32 write_data)
{
    ...
    {
        mtk_w32(eth, PHY_IAC_ACCESS | PHY_IAC_START_C45 | PHY_IAC_CMD_C45_ADDR | PHY_IAC_REG(mdiobus_c45_devad(phy_reg)) | PHY_IAC_ADDR(phy_addr) | PHY_IAC_DATA(mdiobus_c45_regad(phy_reg)),
                MTK_PHY_IAC);
        ...
        mtk_w32(eth, PHY_IAC_ACCESS | PHY_IAC_START_C45 | PHY_IAC_CMD_WRITE | PHY_IAC_REG(mdiobus_c45_devad(phy_reg)) | PHY_IAC_ADDR(phy_addr) | PHY_IAC_DATA(write_data),
                MTK_PHY_IAC);
    }
    else
    {
        mtk_w32(eth, PHY_IAC_ACCESS | PHY_IAC_START_C22 | PHY_IAC_CMD_WRITE | PHY_IAC_REG(phy_reg) | PHY_IAC_ADDR(phy_addr) | PHY_IAC_DATA(write_data),
                MTK_PHY_IAC);
    }
...
static int _mtk_mdio_read(struct mtk_eth *eth, u32 phy_addr, u32 phy_reg)
{
    ...
    if (phy_reg & MII_ADDR_C45)
    {
        ...
        mtk_w32(eth, PHY_IAC_ACCESS | PHY_IAC_START_C45 | PHY_IAC_CMD_C45_READ | PHY_IAC_REG(mdiobus_c45_devad(phy_reg)) | PHY_IAC_ADDR(phy_addr),
                MTK_PHY_IAC);
    }
    else
    {
        mtk_w32(eth, PHY_IAC_ACCESS | PHY_IAC_START_C22 | PHY_IAC_CMD_C22_READ | PHY_IAC_REG(phy_reg) | PHY_IAC_ADDR(phy_addr),
                MTK_PHY_IAC);
    }
                                   ...
                                   phy_interface_t interface, int speed)
{
    ...
    val = (speed == SPEED_1000) ? INTF_MODE_RGMII_1000 : INTF_MODE_RGMII_10_100;
    ...
    val = (speed == SPEED_1000) ? RCK_CTRL_RGMII_1000 : RCK_CTRL_RGMII_10_100;
    mtk_w32(eth, val, TRGMII_RCK_CTRL);

    val = (speed == SPEED_1000) ? TCK_CTRL_RGMII_1000 : TCK_CTRL_RGMII_10_100;
                                              ...
                                              phy_interface_t interface)
{
    ...
    {
        sid = (MTK_HAS_CAPS(eth->soc->caps, MTK_SHARED_SGMII)) ? 0 : mac->id;
...
static int mtk_set_mac_address(struct net_device *dev, void *p)
{
    ...
    if (MTK_HAS_CAPS(eth->soc->caps, MTK_SOC_MT7628))
    {
        mtk_w32(mac->hw, (macaddr[0] << 8) | macaddr[1],
                MT7628_SDM_MAC_ADRH);
        mtk_w32(mac->hw, (macaddr[2] << 24) | (macaddr[3] << 16) | (macaddr[4] << 8) | macaddr[5],
                MT7628_SDM_MAC_ADRL);
    }
    else
    {
                      ...
                      int tx_num, struct mtk_tx_ring *ring, bool gso)
{
    ...
    itx_buf->flags |= (!mac->id) ? MTK_TX_FLAGS_FPORT0 : MTK_TX_FLAGS_FPORT1;
...
static int mtk_dma_init(struct mtk_eth *eth)
{
    ...
    if (MTK_HAS_CAPS(eth->soc->caps, MTK_QDMA))
    {
         ...
         * automatically
         */
        mtk_w32(eth, FC_THRES_DROP_MODE | FC_THRES_DROP_EN | FC_THRES_MIN, eth->soc->reg_map->qdma.fc_th);
...
static int mtk_start_dma(struct mtk_eth *eth)
{
    ...
    {
        mtk_w32(eth, MTK_TX_WB_DDONE | MTK_TX_DMA_EN | MTK_RX_DMA_EN | MTK_MULTI_EN | MTK_PDMA_SIZE_8DWORDS,
                reg_map->pdma.glo_cfg);
    }
